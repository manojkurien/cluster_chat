...
class Config:
    ...
    # Output file paths
    OUTPUT_CSV: str = f"{OUTPUT_DIR}/clustered_conversations.csv"
    OUTPUT_TRENDS_CSV: str = f"{OUTPUT_DIR}/clustered_conversations_trends.csv"
    
    # Output visualization paths
    OUTPUT_PLOT: str = f"{OUTPUT_DIR}/conversation_trends.png"
    OUTPUT_HISTOGRAM: str = f"{OUTPUT_DIR}/conversation_histogram.png"
    OUTPUT_2D_PLOT: str = f"{OUTPUT_DIR}/conversation_clusters_2D.png"
    OUTPUT_MONTHLY_TOTALS: str = f"{OUTPUT_DIR}/conversation_monthly_totals.png"
    OUTPUT_SILHOUETTE: str = f"{OUTPUT_DIR}/silhouette_scores.png"
